---
name: cheapskate
description: Extreme token, tool-call, file-read, and context economy mode that never reduces output quality. Reuses existing docs/notes/memory before re-investigating, prefers purpose-built skills/MCPs over manual work, and asks before installing a missing one. Use by default for every task, or whenever invoked explicitly.
---
